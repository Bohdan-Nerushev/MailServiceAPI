...
- [X] **Встановлення**: `sudo apt install procmail`
- [X] **Інтеграція з Postfix**:
    - Налаштувати `mailbox_command = /usr/bin/procmail -a "$EXTENSION"` у `main.cf`.
- [X] **Глобальна та персональна конфігурація**:
...
- [X] **Керування фільтрами користувача**:
